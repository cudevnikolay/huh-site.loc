...
@section('title', 'Team - Admin Panel | ' . config('app.name'))

@section('content_header')
    <h1 style="display: inline-block">Team</h1>
    <a class="btn btn-success above-table-action" href="{{route('team.create')}}"><i class="glyphicon glyphicon-plus"></i> Add Team Member </a>
@stop
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Delete Team Member</h4>
                </div>
            ...
            <div class="box">
                <div class="box-body">
                    <div class="col-sm-12 table-responsive table-hover">
                        <table id="team" class="table table-bordered table-striped dataTable" role="grid">
                            <thead>
                            <tr role="row">
                                ...
                                <th class="sortable sorting">Position</th>
                                <th>Actions</th>
                            </tr>
                            </thead>
                            <tbody>
