...
class LanguageRepository extends Repository
{
    ...
    public function findActiveByLocale($locale)
    {
        return $this->model->where('locale', $locale)->active()->first();
    }

    public function findByLocaleWithTranslations($locale)
    {
        return $this->model->with('translations')->where('translator_languages.locale', $locale)->first();
    }
    ...
    public function allActiveExcept($locale)
    {
        return $this->model->where('locale', '!=', $locale)->active()->get();
    }
